...
public class Initial_page_5 extends Fragment implements CheckBoxInterface, SpinnerInterface {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        CheckBox checkBoxLipidProfile = view.findViewById(R.id.treatment_lipid_profile);
        ...
        checkBoxTreatment(drugsDose, checkBoxLipidProfile, this);
    ...
    public void updateValues() {
        ...
        try {
            ...
            jsonArry.put(JSONFormBuilder.observations("1271", "", "valueCoded", drugsDose.lipid_profile, DateCalendar.date(), ""));
