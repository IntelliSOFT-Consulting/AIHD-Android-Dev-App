package org.development.aihd.app.adapters.models;
...
import org.development.aihd.app.forms.DM_HTN_Forms;
import org.development.aihd.app.forms.DM_Initial;
import org.development.aihd.app.patient.Profile;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(final View view) {
            ...
            if (person.getIsReport().matches("1")) {
                ...
                graph.putExtra("patient_id", person.get_id());
                graph.putExtra("gender", person.getGender());
                graph.putExtra("identifier", person.getIdentifier() != null ? person.getIdentifier() : "Identifier pending");
