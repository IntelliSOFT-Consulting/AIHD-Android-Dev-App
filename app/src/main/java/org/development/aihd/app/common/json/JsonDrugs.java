package org.development.aihd.app.common.json;

import org.development.aihd.app.common.DateCalendar;
import org.development.aihd.app.common.variables.DrugsDose;
...
public class JsonDrugs {
    ...
    public static JSONArray jsonArrayDrugs(DrugsDose drugsDose, JSONArray jsonArry) {
        ...
        try {
            ...
            JSONFormBuilder.checkLength(jsonArry1, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry2, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry3, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry4, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry5, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry7, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry6, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry8, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry9, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry10, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry11, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry12, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry13, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry14, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry15, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry16, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry17, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry18, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry19, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry20, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry21, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry22, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry23, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry24, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry25, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry26, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry27, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry28, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry29, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry30, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry31, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry32, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry33, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry34, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry35, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry36, jsonGroup);
            JSONFormBuilder.checkLength(jsonArry37, jsonGroup);
