...
import org.development.aihd.app.Home;
import org.development.aihd.app.common.Alerts;
import org.development.aihd.app.common.Common;
import org.development.aihd.app.common.File_Upload;
import org.development.aihd.app.common.JSONFormBuilder;
import org.development.aihd.app.common.Validation;
import org.development.aihd.app.adapters.pages.DM_Initial_Adapter;
...
import org.development.aihd.app.fragments.initial.FragmentModelInitial;
...
import static org.development.aihd.app.common.Alerts.hideDialog;
        ...
        try {
            ...
            if (error.length() == 0 && jsonArray.length() > 0) {
                ...
                if (isConnected) {
                    ...
                    Toast.makeText(this, "Initial Encounter file saved,unable to upload file", Toast.LENGTH_SHORT).show();
                }
