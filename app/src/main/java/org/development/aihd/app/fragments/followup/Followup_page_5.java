...
import org.development.aihd.app.common.json.JsonDrugs;
import org.development.aihd.app.common.JSONFormBuilder;
import org.development.aihd.app.R;
import org.development.aihd.app.common.checkboxes.CheckBoxInterface;
import org.development.aihd.app.common.spinners.SpinnerInterface;
import org.json.JSONArray;

import static org.development.aihd.app.common.checkboxes.CheckBoxDrugs.checkBoxTreatment;
import static org.development.aihd.app.common.spinners.SpinnerDose.spinnerDoseData;
import static org.development.aihd.app.common.spinners.SpinnerFrequency.spinnerDataFrequency;

/**
 * Developed by Rodney on 24/04/2018.
 */

public class Followup_page_5 extends Fragment implements CheckBoxInterface, SpinnerInterface {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dm_followup_fragment_5, container, false);
        ...
        drugsDose.editTextAdmitReason = view.findViewById(R.id.admit_reason);
        ...
        textWatcher(drugsDose.editTextAdmitReason);
    ...
    public void updateValues() {
        ...
        try {
            ...
            jsonArry.put(JSONFormBuilder.observations("162879", "", "valueText", drugsDose.editTextAdmitReason.getText().toString(), DateCalendar.date(), ""));
            ...
            Log.d("JSON FollowUp Page 5", jsonArry.toString() + " ");

            FragmentModelFollowUp.getInstance().followUpFive(jsonArry);
